...
<head>
    ...
    <title>Tambah Data Bimbingan</title>
...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        if(tambah_bimbingan($_POST)) {
            echo '<script>
            swal("Berhasil!", "Data Bimbingan Berhasil Ditambah!", "success")
            .then((value) => {
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="ID_Dosen" name="ID_Dosen" class="form-control" required>
                                                    <option value="" disabled selected hidden>Pilih ID Dosen Pembimbing</option>
                                                    <?php
                                                    $conn = koneksi();
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="bg-primary" name="tambah_bimbingan">
