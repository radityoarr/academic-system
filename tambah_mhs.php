                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="NRP" type="text" class="form-control" id="NRP" placeholder="Masukkan NRP" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="NRP_Komting" name="NRP_Komting" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="ID_Dosen" name="ID_Dosen" class="form-control" required>
                                                    ...
                                                    <?php
                                                    $conn = koneksi();
                                                    $result = sqlsrv_query($conn, "SELECT ID_Dosen FROM Dosen");
                                                        while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="bg-primary" name="tambah_mhs">
